 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
let newArray = alphabetString.split('');
...
let reverseArray = alphabetArray.reverse();
...
myToDoList.push("housework", "homework", "shopping");
console.log(myToDoList);

myToDoList.splice(1,1);
console.log(myToDoList);

yourToDoList = ['laundry', 'dusting'];
...
console.log(reverse(false));         //should return false
